...
const MainReferral = (props:RefProps) => {
    ...
    return (
        <div className=" w-full   mx-auto mt-12 text-center text-white   ">
            <div className="w-[88vw] mx-auto">
            <h1 className=" text-2xl font-bold mb-1">{props.refCount} Referrals</h1>
            <InviteButton  />
            </div>
            <div className=" secondarycolor mx-auto w-[88vw] aspect-[381/104] mt-3 rounded-lg content-center">LeaderBoard Banner</div>
            <div className=" mt-6 max-h-[calc(100vh-200px)]  ">
                <div className=" fixed  bg-[#2A2F53] w-[100vw] rounded-3xl h-full pb-[110px] top-[calc(7svh+200px)]  bottom-0 left-0 pt-4 ">
