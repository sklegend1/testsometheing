    ...
    return (
        <div className={" w-[88vw] mx-auto bg-gradient-to-r from-[#0C1230] grid grid-cols-5 from-[30%] to-[#343B68] mt-2 h-[84px] rounded-xl p-2 border-[#384275] border-2"+tapEffect}
         ...
         >
            ...
            <div className=" relative  ml-[-3vw]  pt-2 ">
                <div>
                    {props.img1&&
                    <div>
                    <Image src={props.img1} width={15} height={15} alt="img1" className=" inline-block" />
                    <p className=" ml-1 inline-block text-white text-[2.5vw] ">3 Pixi NFT</p>
                    </div>}
                    {props.img2&&
                    <div>
                    <Image src={props.img2} width={15} height={15} alt="img2" className=" inline-block" />
                    <p className=" ml-1 inline-block text-white text-[2.5vw] ">5 TON</p>
                    </div>}
                </div>
            </div>
        </div>
