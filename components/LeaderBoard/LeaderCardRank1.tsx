...
const LeaderCardRank1 = (props:taskProps) => {
    ...
    // from-[#b8932e] flex flex-row items-center from-[30%] to-[#554f2e]
    return (
        <div className={" w-[88vw]  relative mx-auto snap-start bg-gradient-to-r from-[#0C1230] flex flex-row items-center from-[30%] to-[#343B68]  mt-2 h-[68px] rounded-xl p-2 border-[#ffeea1] border-2"+tapEffect}
            onTouchStart={tapToggle}
            onTouchEnd={()=>setTapEffect("")}
         >
            <div className=" text-white font-body text-4xl ml-1 w-10">{props.rank}</div>
...
export default LeaderCardRank1;